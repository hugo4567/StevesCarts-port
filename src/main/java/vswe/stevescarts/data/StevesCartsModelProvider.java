...
public class StevesCartsModelProvider extends FabricModelProvider {
	...
	public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
		...
		blockStateModelGenerator.registerCubeWithCustomTextures(StevesCartsBlocks.MODULE_TOGGLER_BLOCK, null, (block, ignored) -> new TextureMap().put(TextureKey.PARTICLE, StevesCarts.id("block/module_toggler_block_top")).put(TextureKey.UP, StevesCarts.id("block/module_toggler_block_top")).put(TextureKey.DOWN, StevesCarts.id("block/module_toggler_block_bot")).put(TextureKey.SOUTH, StevesCarts.id("block/module_toggler_block_side")).put(TextureKey.NORTH, StevesCarts.id("block/module_toggler_block_side")).put(TextureKey.EAST, StevesCarts.id("block/module_toggler_block_side")).put(TextureKey.WEST, StevesCarts.id("block/module_toggler_block_side")));
