...
import vswe.stevescarts.module.addon.CageModule;
import vswe.stevescarts.module.addon.CakeServerModule;
import vswe.stevescarts.module.addon.ChunkLoaderModule;
import vswe.stevescarts.module.addon.ColorizerModule;
...
import vswe.stevescarts.module.addon.LiquidCleanerModule;
import vswe.stevescarts.module.addon.MelterExtremeModule;
import vswe.stevescarts.module.addon.MilkerModule;
...
public class StevesCartsModules {
	...
	public static final ModuleType<CageModule> CAGE = register("cage", new ModuleType<>(CageModule::new, StevesCarts.id("cage"), 18, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
	public static final ModuleType<CakeServerModule> CAKE_SERVER = register("cake_server", new ModuleType<>(CakeServerModule::new, StevesCarts.id("cake_server"), 8, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
	...
	public static final ModuleType<IncineratorModule> INCINERATOR_ADDON = register("incinerator_addon", new ModuleType<>(IncineratorModule::new, StevesCarts.id("incinerator_addon"), 15, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
	...
	public static final ModuleType<LiquidCleanerModule> LIQUID_CLEANER_ADDON = register("liquid_cleaner_addon", new ModuleType<>(LiquidCleanerModule::new, StevesCarts.id("liquid_cleaner_addon"), 12, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
	...
	public static final ModuleType<MilkerModule> MILKER = register("milker", new ModuleType<>(MilkerModule::new, StevesCarts.id("milker"), 12, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
	...
	public static final ModuleType<TreeTapModule> TREE_TAP_ADDON = register("tree_tap_addon", new ModuleType<>(TreeTapModule::new, StevesCarts.id("tree_tap_addon"), 10, EnumSet.noneOf(ModuleSide.class), ModuleGroup.ADDON, false, false, false, null, null));
